        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 pt-12 lg:pt-16">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            {courseData.tags.map((tag, index) => (
              <span key={index} className="px-4 py-1.5 bg-white/10 backdrop-blur rounded-full text-white text-sm font-medium">
                {tag}
              </span>
            ))}
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 md:gap-12 mb-12 text-white">
            ...
            <div className="flex items-baseline gap-2">
              ...
              {courseData.isPaid && <span className="text-gray-300 line-through">₹{courseData.price + 2000}</span>}
            </div>
          </div>
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="transform transition-all group-hover:scale-110">
                    ...
                    <p className="text-center text-white mt-4 font-medium">Preview this course</p>
                  </div>
                </div>
              </div>
            ) : (
      ...
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3 p-4 rounded-lg bg-purple-50 hover:bg-purple-100 transition-colors">
            ...
            {/* Course Requirements */}
            <div>
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Course Requirements</h2>
