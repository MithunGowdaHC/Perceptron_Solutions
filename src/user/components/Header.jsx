          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 min-h-[calc(100vh-80px)] flex items-center">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 w-full">
              ...
              <div className="lg:w-1/2 w-full max-w-2xl mx-auto">
                <div className="relative">
                  {/* Animated background blobs */}
                  <div className="absolute -top-4 -right-4 w-72 h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-blob hidden sm:block" />
                  <div className="absolute -bottom-4 -left-4 w-72 h-72 bg-blue-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-blob animation-delay-2000 hidden sm:block" />
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/20 dark:to-blue-900/20 rounded-3xl transform rotate-1" />
